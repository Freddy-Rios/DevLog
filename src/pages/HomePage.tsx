      ...
      <div className="flex justify-center items-center  bg-gray-100 p-4">
        ...
        <div className="flex items-stretch space-x-8">
          <Card className={cn("w-[380px]")}>
            ...
            <CardContent>
              <h3 className="font-bold">About the dev</h3>
              <p>
                here we will have information about the Developer we can put
                whatever we want like personal information or more information
                about coding and what we have or reasons for why we are on the
                website stuff like that is the idea.
                <br /> test that this is new line <br /> it is so that means
                this works put all info in this p tag
              </p>
            </CardContent>
            <CardFooter>
              {/* Github */}
